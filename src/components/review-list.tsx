...
const mockReviews = [
  {
    ...
    tags: {
      communication: 'positive' as 'positive',
      consistency: 'positive' as 'positive',
      understanding: 'neutral' as 'neutral',
    },
  ...
  },
  {
    ...
    tags: {
      communication: 'negative' as 'negative',
      consistency: 'positive' as 'positive',
      understanding: 'positive' as 'positive',
    },
